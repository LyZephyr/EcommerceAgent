...
def get_product_detail(product_id: str) -> dict | None:
    ...
    if product is None:
        return None
    return product_presenter.build_product_detail(product)


def product_card_payload(product: dict, *, group_label: str | None = None) -> dict:
    return product_presenter.product_card_payload(product, group_label=group_label)


def product_availability(product: dict) -> tuple[str, str | None]:
    return product_presenter.product_availability(product)
